...
/**
 *
 * This class implements IPLuginBase interface to generate maven pmd reports
 *
 */

class MavenPmdReporter implements IPluginBase {
    ...
    public void addOptions(context, HashMap<String, String> data) {
        ...
        context.with {
            ...
            configure {
                ...
                rep << 'hudson.plugins.pmd.PmdReporter'(plugin: "pmd@3.47") {
