...
/**
 *
 * This class implements IPLuginBase interface to generate maven checkstyle reports
 *
 */

class MavenCheckStyleReporter implements IPluginBase {
    ...
    public HashMap<String, String> performMapping(IDPJob idpJobObj) {
        ...
        data.put('healthy', '')
        data.put('unHealthy', '')
        data.put('pluginName', '[CHECKSTYLE]')
    ...
    public void addOptions(context, HashMap<String, String> data) {
        ...
        context.with {
            ...
            configure {
                ...
                rep << 'hudson.plugins.checkstyle.CheckStyleReporter'(plugin: "checkstyle@3.47") {
