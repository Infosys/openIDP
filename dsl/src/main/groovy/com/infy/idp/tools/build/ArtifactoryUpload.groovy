...
import com.infy.idp.plugins.wrappers.ArtifactoryArtifactUploader
...
/**
 *
 * This class has the method to create the Artifactory upload job based for the AngularJS technology
 *
 */
...
class ArtifactoryUpload {
    ...
    /*
     * This method is used to create a free style artifactory job
     */

    public static String freeStyleArtifactory(context, jsonData, envVar,buildID) {
        ...
        context.with {
            ...
            (new ArtifactoryArtifactUploader()).add(context, jsonData)
        }

    }

    /*
     * This method is used to create Jfrog artifactory upload job for maven and ant
     */
