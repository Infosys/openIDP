...
/**
 * the class createbuildlog has method for generating buildlog report
...
public class CreateBuildLog {
	...
	/**
	 * method to create buildlog reports
	 * @param server
	 * @param username
	 * @param password
	 * @param jobName
	 ...
	 * @param appName
	 */
	public static void createBuildLog(String server,  String username, String password, String jobName,
			String destPath, String time, String id, String appName) {
