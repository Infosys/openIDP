...
{
	if (this.jUnitReports==null){jUnitReports=new ArrayList<>();}
...
{
	if (this.jMeterReports==null){jMeterReports=new ArrayList<>();}
...
{
	if (this.coberturareports==null){coberturareports=new ArrayList<>();}
...
{
	if (this.accelerateReports==null){accelerateReports=new ArrayList<>();}
...
{
	if (this.checkmarkreports==null){checkmarkreports=new ArrayList<>();}
...
{
	if (this.checkReports==null){checkReports=new ArrayList<>();}
...
{
	if (iTopsReps==null){iTopsReps=new ArrayList<>();}
...
/*public void AddSeleniumReport(String URL1)
{
	if (seleniumReports==null){seleniumReports=new ArrayList<>();}
...
{
	if (robotReports==null){robotReports=new ArrayList<>();}
...
{
	if (iFastReports==null){iFastReports=new ArrayList<>();}
...
{
	if (qualitia==null){qualitia=new ArrayList<>();}
...
{
	if (findBugsReports==null){findBugsReports=new ArrayList<>();}
...
{
	if (pmdReports==null){pmdReports=new ArrayList<>();}
