...
public class ConvertTSLintReport {
	...
	public static void setTotalSeverities(List<CodeAnalysis>ca)
	{
		for (CodeAnalysis codeAnalysis : ca) {
			if(codeAnalysis.getSeverity().equalsIgnoreCase("low") && codeAnalysis.getcategory().equalsIgnoreCase("tslint") ) lowViolations++;
			if(codeAnalysis.getSeverity().equalsIgnoreCase("medium")&& codeAnalysis.getcategory().equalsIgnoreCase("tslint")) mediumViolations++;
			if(codeAnalysis.getSeverity().equalsIgnoreCase("high")&& codeAnalysis.getcategory().equalsIgnoreCase("tslint")) highViolations++;
	...
	/**
	 * returns list of codeanalysis objects after parsing tslint reports
	 * @param inputPath
	 * @param ca
	 * @return
	 */
