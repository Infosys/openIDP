...
public class ConvertCoverage {
	...
	/**
	 * method to parse coverage details
	 * @param inputPath
	 * @param jsonClass
	 * @return
	 */
	public static JsonClass convert(String inputPath, JsonClass jsonClass) {
		...
		try {
			...
			Coverage c = (Coverage) jaxbUnmarshaller
					.unmarshal(file);
	...
	private static void iterateClasses(Coverage.Packages.Package p2,
			List<CodeMetric> listCov) {
