...
(function (String, angular) {
        ...
        var reset = function (el) {
          ...
          makeValid = function (el) {
              ...
              if (frmGroupEl) {
                  ...
                  if (addValidationStateIcons) {
                      ...
                      var iconElText = '<span class="glyphicon glyphicon-ok form-control-feedback" style="right:85px; display:none;"></span>';
          ...
          makeInvalid = function (el, errorMsg) {
              ...
              if (frmGroupEl) {
                  ...
                  if (addValidationStateIcons) {
                      var iconElText = '<span class="glyphicon glyphicon-remove form-control-feedback" style="right:85px;"></span>';
                      if (inputGroupEl.length > 0) {
                          iconElText = iconElText.replace('form-', '');
                          iconElText = '<span class="input-group-addon control-feedback">' + iconElText + '</span>';
                      }
    ...
    angular.autoValidate.errorMessages['default'] = {
        ...
        pattern: 'The input can only consist of alphabetical, number, dot and underscore',
