...
export class BuildInfoSubComponent implements OnInit {
  ...
  dotNetVersionsForFortify: string[] = [
    "3.5",
    "4.0",
    "4.5",
    "4.6",
  ...
  constructor(
    ...
    if (
      this.IdpdataService.application &&
      this.IdpdataService.application.checkMarxDetails &&
      this.IdpdataService.application.checkMarxDetails.checkmarxUrl &&
      this.IdpdataService.application.checkMarxDetails.checkmarxUrl !== ""
    ) {
    ...
    if (
      this.codeInfo.buildScript[2] !== undefined &&
      this.codeInfo.buildScript[2].type === "xml"
    ) {
  ...
  /* checkmarx method */
  getCheckmarxDetails() {
    this.IdprestapiService.getCheckmarxData(
      this.IdpdataService.application.checkMarxDetails
    ).then((response) => {
      try {
        ...
        try {
          ...
          if (parsed) {
            ...
            if (
              ...
              // console.log(
              //   "getApplicationDetails : this.IdpdataService.artifactVariable ===" +
              //     this.IdpdataService.artifactVariable
              // );
              // console.log(
              //   "getApplicationDetails : this.IdpdataService.artifactAppVariable ===" +
  ...
  detailsApplication() {
    this.getApplicationDetails(
      this.IdpdataService.data.basicInfo.applicationName
    );
  }
  ...
  checkCheckBox() {
    ...
    if (
      (this.buildInfo.checkmarxAnalysis.excludeFiles !== undefined &&
        this.buildInfo.checkmarxAnalysis.excludeFiles !== null &&
        this.buildInfo.checkmarxAnalysis.excludeFiles !== "") ||
      (this.buildInfo.checkmarxAnalysis.excludeFileso !== undefined &&
        this.buildInfo.checkmarxAnalysis.excludeFileso !== null &&
        this.buildInfo.checkmarxAnalysis.excludeFileso !== "") ||
      (this.buildInfo.checkmarxAnalysis.sastHigh !== undefined &&
        this.buildInfo.checkmarxAnalysis.sastHigh !== null &&
        this.buildInfo.checkmarxAnalysis.sastHigh !== "") ||
      (this.buildInfo.checkmarxAnalysis.sastMedium !== undefined &&
        this.buildInfo.checkmarxAnalysis.sastMedium !== null &&
        this.buildInfo.checkmarxAnalysis.sastMedium !== "") ||
      (this.buildInfo.checkmarxAnalysis.sastLow !== undefined &&
    ...
    if (
      (this.buildInfo.postBuildScript.tool !== undefined &&
        this.buildInfo.postBuildScript.tool !== null &&
        this.buildInfo.postBuildScript.tool !== "") ||
      (this.buildInfo.postBuildScript.archiveLogs !== undefined &&
    ...
    if (
      this.buildInfo.artifactToStage.artifactRepoName !== undefined &&
    ...
    if (
      this.buildInfo.artifactToStage.artifactRepo !== undefined &&
      this.buildInfo.artifactToStage.artifactRepo.dockerRegistryUrlDR !==
        undefined &&
      this.buildInfo.artifactToStage.artifactRepo.dockerRegistryUrlDR !== ""
    ) {
    ...
    if (
      this.buildInfo.artifactToStage.nuspecFilePath !== undefined &&
      this.buildInfo.artifactToStage.nuspecFilePath !== null &&
    ...
    if (
      this.buildInfo.postBuildScript &&
      this.buildInfo.postBuildScript.javaOptions !== undefined
    ) {
  ...
  getArtifactPatterStatus() {
    ...
    if (this.checkBoxObject.artifact === "on") {
      return (
        this.buildInfo.artifactToStage.artifactRepoName === "nexus" ||
        this.buildInfo.artifactToStage.artifactRepoName === "jfrog"
      );
    } else if (this.checkBoxObject.artifact === "off") {
      if (this.IdpdataService.artifactAppVariable) {
        if (this.IdpdataService.isDockerRegistry === false) return true;
      }
    }
  ...
  checkTechnologyAndPackage() {
    if (
      ...
      this.buildInfo.buildtool === "mainframe" ||
      this.buildInfo.buildtool === "general" ||
      this.codeInfo.category === "Package"
    ) {
      return false;
    } else {
      return true;
