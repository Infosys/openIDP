...
export class IdprestapiService {
  ...
  constructor(
    ...
    this.idpdataService.devServerURL = this.startupData.idpresturl;
    ...
    if (this.idpdataService.authmode === "azureAd") {
      ...
      this.idpdataService.adalConfig.endpoints[
        this.startupData.endpoints
      ] = this.startupData.endpoints;
      this.adalSvc.init(
        JSON.parse(JSON.stringify(this.idpdataService.adalConfig))
      );
  ...
  getUserName(): Promise<any> {
    this.idpdataService.devServerURL = this.startupData.idpresturl;
    const url =
      this.idpdataService.devServerURL +
      "/userService/jobid1/getUserRolesPermissions";
    const headers = new Headers();
    let cookie;
    headers.append("Content-type", "application/json");
    if (this._cookieService.get("access_token")) {
  ...
  getWorkItems(workitem): Promise<any> {
    ...
    headers.append(
      "Authorization",
      "Basic " +
        this.base64EncodeDecode(
          this.idpdataService.uName,
          this.idpdataService.pass
        )
    );
    const options = new RequestOptions({ headers: headers });
  ...
  getUserStories(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/trigger/pipelines/stories/" + data;
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  updatePlan(data1, data2, data3, envData): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/updateRelease/" +
      data1 +
      "/" +
      data2 +
      "/" +
  ...
  getOrganizationWiseApplicationNames(): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/IDP/org/applications/names ";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getTimeZone(): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/releaseService/serverTimeZone";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getAvailableSlot(data1, data2, data3): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/releaseService/release/availableSlot/" +
      data2 +
      "/" +
      data1 +
      "/" +
  ...
  getPipelineDetails(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/jobService/IDP/jobid1/getPipelineDetails";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  checkForApplicationType(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/sapJobService/pipelines/sapApplication/" +
      data;
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
  ...
  getEnvSlots(application_name, env): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/releaseService/existingEnvSlots/" +
      application_name +
      "/" +
      env;
    let cookie;
  ...
  emailToEnvOwner(envOwner): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/releaseService/environment/mail";
    let cookie;
    const headers = new Headers();
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getPipelineEnv(data, data1): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/environment/pipelines/" +
      data1 +
      "/" +
      data;
    const headers = new Headers();
  ...
  getEnvironmentNames(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/jobid1/getEnvironmentNames";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getLandscapesForSap(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/sapJobService/pipelines/landscapes/" +
      data;
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
  ...
  getVariantNamesForSap(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/sapJobService/pipelines/variant/" +
  ...
  getTransportRequest(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/sapJobService/pipelines/transportrequest/" +
      data.application_name +
      "?landscapeName=" +
      data.landscapeName +
      "&&deployOperation=" +
  ...
  getUserStoriesSAP(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/sapJobService/pipelines/userstories/" +
      data.application_name +
      "/" +
      data.pipeline_name +
      "/" +
  ...
  checkAvailableJobs(): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/jobService/checkAvailableJobsToTrigger";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  triggerJob(request): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/jobService/jobid1/TriggerInputs";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  createCloudApplication(requestData): Promise<any> {
    const url =
      this.idpdataService.cloudDeployURL +
      "/deploymentService/application/createApplication";
    //console.log(url);
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
  ...
  createLoadBalancer(requestData): Promise<any> {
    const url =
      "http://localhost:8092/deployment/deploymentService/application/createApplication";
    //console.log(url);
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
  ...
  createCloudPipeline(requestData): Promise<any> {
    const url =
      this.idpdataService.cloudDeployURL +
      "/deploymentService/pipeline/createPipeline";
    //console.log(url);
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
  ...
  copyeditCloudPipeline(appName, pipName): Promise<any> {
    const url =
      this.idpdataService.cloudDeployURL +
      "/deployment/deploymentService/pipeline/" +
      appName +
      "/" +
      pipName +
      "/getPipelineInfo";
  ...
  submit(requestData): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/jobService/IDP/jobid1/submitJob";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  triggerJobs(requestData): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/jobService/jobid1/triggerJobs";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getApplicationDetails(requestData): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/jobid1/getApplicationDetails";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  deletePipeline(requestData): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/jobService/jobid1/deletePipeline";
  ...
  getExistingApps(): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/jobService/IDP/jobid1/getExistingApps";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getApplicationInfo(requestData): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/jobid1/getAppInfo";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getFilteredApplicationNames(filterString): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/IDP/jobid1/filter/Application/" +
      filterString;
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
  ...
  editApplicationDetails(requestData): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/jobid1/updateAppinfo";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  createApplication(requestData): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/jobid1/createApplication";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getJobs(requestData): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/jobService/IDP/jobid1/getJobs";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getPipelineList(responseData): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/jobService/jobid1/getDependencyJobs";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  sendAppMail(responseData): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/applications/mail";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  sendOrgMail(responseData): Promise<any> {
    const url =
      this.idpdataService.subscriptionServerURL +
      "/org/registrationServices/mail";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  sendLicenseMail(responseData): Promise<any> {
    const url =
      this.idpdataService.subscriptionServerURL +
      "/org/registrationServices/license/mail";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  sendPipeMail(responseData): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/jobService/jobid1/jobCreationSuccessMail";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getPipelineNames(requestData): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/jobService/pipelines/list/" +
      this.idpdataService.releaseManagerData.applicationName +
      "/" +
      "release";
    const headers = new Headers();
    let cookie;
  ...
  getExistingAppNames(): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/IDP/applications/names";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  checkSubApplication(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/getSubApplication?appName=" +
      data;
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
  ...
  getApplicationNameForReleaseManager(responseData): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/applicationService/IDP/applications/release/list ";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  postReleaseData(responseData): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/releaseService/release/insert/" +
      this.idpdataService.releaseManagerData.applicationName +
      "/" +
      this.idpdataService.pipelineListRm;
    const headers = new Headers();
    let cookie;
  ...
  getArtifactsApprovePortal(data): Promise<any> {
    var url =
      this.idpdataService.devServerURL + "/releaseService/getApprovedArtifact";
    let headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  updateReleases(responseData): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/releaseService/release/update";
    const headers = new Headers();
    let cookie;
  ...
  getArtifactsRm(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/releaseService/getArtifactDetails";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  updateArtifacts(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/releaseService/update/artifact";
    const headers = new Headers();
    let cookie;
    //console.log(data);
    if (this._cookieService.get("access_token")) {
  ...
  getSlaveStatus(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/trigger/slavestatus/" + data;
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getArtifactLatestDetails(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/releaseService/latest/artifact/details/" +
      data;
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
  ...
  getPipelineAdmins(appName): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/trigger/pipelineAdmins?applicationName=" +
      appName;
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
  ...
  getPipelinePermission(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/jobService/pipelinepermission?applicationName=" +
  ...
  approveJobs(requestData): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/jobService/jobid1/approveJobs";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getSubscriptionPermission(): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/subscriptionService/subscriptions";
    const data = {};
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
  ...
  createOrganization(requestData): Promise<any> {
    const url =
      this.idpdataService.subscriptionServerURL +
      "/org/registrationServices/register";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getExistingOrgNames(): Promise<any> {
    const url =
      this.idpdataService.subscriptionServerURL +
      "/org/registrationServices/organizations";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  editOrganizationDetails(requestData): Promise<any> {
    const url =
      this.idpdataService.subscriptionServerURL +
      "/org/registrationServices/update";
    const headers = new Headers();
    let cookie;
    if (this._cookieService.get("access_token")) {
      cookie = this._cookieService.get("access_token");
  ...
  getCheckmarxData(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/jobService/getCheckMarxData";
    const headers = new Headers();
    let cookie;
    headers.append("Content-type", "application/json");
    if (this._cookieService.get("access_token")) {
  ...
  getAppmartDetails(data): Promise<any> {
    const url =
      this.idpdataService.devServerURL + "/jobService/getAppmartDetails";
    const headers = new Headers();
    let cookie;
    headers.append("Content-type", "application/json");
    if (this._cookieService.get("access_token")) {
  ...
  getRmsApplicationName(appname): Promise<any> {
    const url =
      this.idpdataService.devServerURL +
      "/jobService/getRmsApplicationName/" +
      appname;
    const headers = new Headers();
    let cookie;
    headers.append("Content-type", "application/json");
